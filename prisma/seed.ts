...
setTimeout(async () => {
  ...
  try {
    ...
    const airlines = [
      ...
      { name: "Arik Air", iata: "W3", icao: "AKP", logo: "/airlines/arik-air.png", hub: "LOS" },
      { name: "Aero Contractors", iata: "N2", icao: "NIG", logo: "/airlines/aero-contractors.png", hub: "ABV" },
      { name: "Max Air", iata: "VM", icao: "NGL", logo: "/airlines/max-air.png", hub: "KAN" },
      ...
      { name: "Green Africa Airways", iata: "Q9", icao: "GFY", logo: "/airlines/green-africa.png", hub: "LOS" },
      ...
      { name: "ValueJet", iata: "VK", icao: "VJT", logo: "/airlines/valuejet.png", hub: "LOS" },
      { name: "Rano Air", iata: "RN", icao: "RAO", logo: "/airlines/rano-air.png", hub: "KAN" },
      { name: "XEJet", iata: "U0", icao: "XEJ", logo: "/airlines/xejets.png", hub: "ABV" },
      { name: "NG Eagle", iata: "ND", icao: "NGE", logo: "/airlines/ng-eagle.png", hub: "ABV" },
      { name: "West Link Airlines", iata: "WL", icao: "WLA", logo: "/airlines/west-link.png", hub: "ABV" },
      { name: "Pan African Airlines", iata: "PF", icao: "NFL", logo: "/airlines/pan-african.png", hub: "LOS" },
      { name: "Allied Air", iata: "LP", icao: "AJK", logo: "/airlines/allied-air.png", hub: "LOS" },
      { name: "K-Impex Airline", iata: "KX", icao: "KXP", logo: "/airlines/k-impex.png", hub: "ABV" },
      { name: "Dornier Aviation Nigeria", iata: "DH", icao: "DAV", logo: "/airlines/dornier.png", hub: "LOS" },
    ];
